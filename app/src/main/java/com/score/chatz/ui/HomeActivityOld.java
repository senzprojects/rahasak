 ...
 */
public class HomeActivityOld extends FragmentActivity {

    private static final String TAG = HomeActivityOld.class.getName();
    ...
    private HomeActivityOld curActivity;
    ...
    private ServiceConnection senzServiceConnection = new ServiceConnection() {
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            try {
                ...
                PreferenceUtils.saveUser(HomeActivityOld.this, new User("id", user));
    ...
    private void initDrawerList() {
        ...
        drawerAdapter = new DrawerAdapter(HomeActivityOld.this, drawerItemList);
